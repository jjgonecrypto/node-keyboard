...
const { toRepl, toAudio, unpipeAll, toPiano, withDelay, fromArray } = require('./streams')
...
piano.draw().on('end', () => {
    ...
    // attach all stream factories
    replServer.context.toRepl = toRepl
    replServer.context.toAudio = toAudio
    replServer.context.toPiano = toPiano
    replServer.context.withDelay = withDelay
    replServer.context.fromArray = fromArray
